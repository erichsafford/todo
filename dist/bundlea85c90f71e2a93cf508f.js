...
var addProject = function addProject(projectList) {
...
var Item = /*#__PURE__*/_createClass(function Item(title, desc, due, priority) {
...
var List = /*#__PURE__*/function () {
  ...
  _createClass(List, [{
    ...
    value: function displayList() {
      this.listOfItems.forEach(function (object) {
...
/* harmony export */ });
/* harmony import */ var _assets_emptybox_svg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./assets/emptybox.svg */ "./src/assets/emptybox.svg");
...
var cardFactory = function cardFactory(list) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   timeUntilDueDate: () => (/* binding */ timeUntilDueDate)
/* harmony export */ });
...
/* harmony export */ });
var toggleComplete = function toggleComplete(item) {
  item.complete = !item.complete;
  console.log("Switched ".concat(item.title, " to ").concat(item.complete));
};
...
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Josefin+Sans:wght@100;400;600;700&family=Playfair+Display:wght@400;600;800&display=swap);"]);
// Module
...
module.exports = __webpack_require__.p + "emptybox.svg";
